...
value:any;
  ...
  result: any;
    ...
    /*  
     getUser(payment:LoginAccount): Observable<Object> {
  
      console.log(payment)
      
      //return this.http.get(`${this.baseUrl}` +'/getcopoun?userName=${userName}');
      return this.http.get(`${this.baseUrl}` +`/code?userName=${payment.username}` ,);
     }     */
    }
